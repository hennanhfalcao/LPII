...
public class MainAgenda {
	...
	private static void listaContatos(Agenda agenda) {
		for (int i = 0; i < agenda.getCount(); i++) {
			if(agenda.getContato(i)!=null) {
				System.out.println(agenda.getContato(i).toStringListar());
					}
				}
			}
	/**
	...
	private static void listaFavoritos(Agenda agenda) {
		for (int i = 0; i < agenda.getCountFavoritos(); i++) {
			if(agenda.getFavorito(i)!=null) {
				System.out.println(agenda.getFavorito(i).toStringListarFavorito());
					}
				}
			}
/**
	...
	/**
	 * Cadastra um novo contato favorito
	 * @param agenda A agenda
	 * @param scanner Scanner pra pedir informações do contato.
	 */
	private static void adicionaFavorito(Agenda agenda, Scanner scanner) {
		...
		String mensagem = agenda.adicionaFavorito(posicao, posicaofavorito);
		System.out.println(mensagem);
		}
	/**
	 * Remove um favorito da lista de favoritos
	 * @param agenda A agenda
	 * @param scanner Scanner pra pedir informações do contato.
	 */
